...
class ScheduleTest {
    ...
    void findFirstAvailableSlot_lateButAvail_returnsEarlySlot() {
        ...
        assertEquals(expected, sample.findFirstAvailableSlot(expected.getStart(), ).get());
    }
    ...
    void findFirstAvailableSlot_alreadyEarliest_returnsItself() {
        ...
        assertEquals(threeHourTask, sample.findFirstAvailableSlot(TEN_AM, ).get());
    }
    ...
    void findFirstAvailableSlot_notAvailable_returnsEmpty() {
        ...
        assertTrue(sample.findFirstAvailableSlot(TEN_AM, ).isEmpty());
    }
