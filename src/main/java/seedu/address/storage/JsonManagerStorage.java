 ...
 * and Task Manager.
 */
public class JsonManagerStorage {

    private static final Logger logger = LogsCenter.getLogger(JsonManagerStorage.class);

    private Path filePath;

    public JsonManagerStorage(Path filePath) {
